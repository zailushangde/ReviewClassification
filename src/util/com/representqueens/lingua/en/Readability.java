package util.com.representqueens.lingua.en;

import util.com.representqueens.lingua.en.Fathom.Stats;
...
public final class Readability {
	 ...
	 * Michael O'Mahony
	 * 
	 * Computes SMOG readability measure.
	 * 
	 * <p> 
	 * A simple formula for estimating the difficulty of writing (see http://simple.wikipedia.org/wiki/List_of_readability_tests).
	 * </p>
	 * 
	 * @param stats
	 * @return SMOG score.
	 */
	public static float calcSMOG(final Stats stats) {
		return 1.0430f * (float)Math.sqrt(stats.getNumComplexWords() * 30.0 / stats.getNumSentences()) + 3.1291f; 
	}
